...
export const CartCard = ({ product }: CartCardProps) => {
  return (
    <motion.div
      ...
      className="flex max-sm:flex-col hover:shadow-product-card-shadow h-full transition-shadow"
    >
      <div className="flex justify-center items-center bg-grey w-max max-sm:w-full max-sm:h-[227px] max-[535px]:overflow-hidden">
        <Image
          className="sm:min-w-[256px] h-full object-contain"
          src={product.imgUrl}
          width={235}
          height={256}
          alt="product"
      ...
      <div className="flex flex-col justify-between gap-3 xs:gap-5 bg-white xs:py-10 p-5 sm:p-10 grow">
